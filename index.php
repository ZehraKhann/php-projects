        ...
        <div class="row">
            <?php
                ...
                foreach ($result as $row) {
                    ...
                    <div class="col-md-4">
                        <div class="item">
                            <div class="photo"><img  style="width: 100px;" src="assets/uploads/<?php echo $row['photo']; ?>" alt="<?php echo $row['title']; ?>"></div>
                    ...
                    foreach ($result as $row) {
                        ...
                        <div class="item">
                            ...
                            <div class="text">
                                ...
                                <?php else: ?>
                                    <p><a style="background-color: #e4144d;" href="product.php?id=<?php echo $row['p_id']; ?>">Add to Cart</a></p>
                                <?php endif; ?>
                            </div>
                        </div>
                        <?php
