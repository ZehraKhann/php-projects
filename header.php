	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 col-sm-6 col-xs-12">
				<div class="left">
					<ul>
						<li style="font-weight: bolder; color: #e4144d;"><i style="color: #e4144d;"  class="fa fa-phone"></i> <?php echo $contact_phone; ?></li>
						<li style="font-weight: bolder; color: #e4144d;"><i style="color: #e4144d;" class="fa fa-envelope-o"></i> <?php echo $contact_email; ?></li>
					</ul>
				</div>
			</div>
			<div class="col-md-6 col-sm-6 col-xs-12">
	...
	<div class="container">
		<div class="row inner">
			<div class="col-md-4 logo">
				<a href="index.php"> <span style="color: #e4144d; font-size: 2rem; font-weight: bolder; text-decoration: underline 4px;"> THRIFT </span> <span style="color: black; font-size: 2rem; font-weight: 900; text-decoration: underline 4px;"> FASHION</span> <!-- <img src="assets/uploads/<?php echo $logo; ?>" alt="logo image"> --></a>
			</div>
			...
			<div class="col-md-5 right">
				<ul>
					...
					if(isset($_SESSION['customer'])) {
						...
						?>
						<li><a href="login.php" style="font-weight: bolder; color: #e4144d;"><i class="fa fa-sign-in"></i> <?php echo LANG_VALUE_9; ?></a></li>
						<li><a href="registration.php" style="font-weight: bolder; color: #e4144d;"><i class="fa fa-user-plus"></i> <?php echo LANG_VALUE_15; ?></a></li>
						<?php	
					}
					?>

					<li><a href="cart.php" style="font-weight: bolder; color: #e4144d;"><i class="fa fa-shopping-cart"></i> <?php echo LANG_VALUE_19; ?> (<?php echo LANG_VALUE_1; ?><?php
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 pl_0 pr_0">
				<div class="menu-container" style="font-weight: bolder;" >
					<div class="menu">
						<ul>
